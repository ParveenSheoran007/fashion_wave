      ...
      body: Stack(children: [
        ...
        Padding(padding: const EdgeInsets.all(16),
          child: Column(mainAxisAlignment: MainAxisAlignment.center,
            children: [ Center(
                child: Image.asset('assets/Screenshot_2024-07-17_123441-removebg-preview.png',
                  width: 200,)),
              ...
              TextFormField(
                ...
                height: 16,),
              GestureDetector(onTap: userProvider.isLoading
                  ? null : () {
                ...
                decoration: BoxDecoration(color: Colors.red.shade400,
                  borderRadius: BorderRadius.circular(40),),
                child: Center(child: userProvider.isLoading
